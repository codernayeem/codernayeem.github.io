...
const Navbar = () => {
  ...
  return (
    <header className="fixed w-full top-0 z-50 backdrop-blur bg-white/70 dark:bg-gray-900/70 border-b border-gray-200 dark:border-gray-800">
        ...
        <nav className="hidden md:flex space-x-2 items-center">
          {navItems.map((item) => (
            <Link
              ...
              offset={-70}
              duration={500}
              className="cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800 rounded-md p-2 text-center transition-all duration-500"
